...
HARDWARE = [
    {
        ...
        'tasklist':[
            ...
            'The drive will be a slave but not us a master',
            'Even after detecting hard disk still it not working and I get errors',
            ...
            'System Reboots Power good voltage level is out of limit',
            'Electrical Shocks on case. Power supply is not grounding properly',
            'System Cant Maintain correct date and Time when turned off',
            'BIOS Update fails BIOS are not compatible',
